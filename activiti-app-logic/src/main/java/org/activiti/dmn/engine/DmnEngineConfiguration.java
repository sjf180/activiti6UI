...
import org.activiti.dmn.engine.impl.*;
import org.activiti.dmn.engine.impl.cfg.*;
...
import org.activiti.dmn.engine.impl.interceptor.*;
...
import org.activiti.dmn.engine.impl.persistence.deploy.*;
import org.activiti.dmn.engine.impl.persistence.entity.*;
...
public class DmnEngineConfiguration {
  ...
  /**
   * the configurable list which will be {@link #initInterceptorChain(List) processed} to build the {@link #commandExecutor}
   */
  ...
  public void initDbSchema() {
    try {
      ...
      Liquibase liquibase = new Liquibase("META-INF/liquibase/activiti-dmn-db-changelog.xml", new ClassLoaderResourceAccessor(), database);
