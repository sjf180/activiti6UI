...
import org.activiti.form.engine.impl.cfg.*;
...
import org.activiti.form.engine.impl.interceptor.*;
...
import org.activiti.form.engine.impl.persistence.deploy.*;
...
public class FormEngineConfiguration {
  ...
  public void initDbSchema() {
    try {
      ...
      Liquibase liquibase = new Liquibase("META-INF/liquibase/activiti-form-db-changelog.xml", new ClassLoaderResourceAccessor(), database);
